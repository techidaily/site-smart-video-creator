...
// ------------------------------------------------------------------------------------------- 以下内容需要自己替换
const subSiteAuthor = 'Charlotte';
const subSiteKeywords = `smart video ai tool, smart video creator, ai video creator` + ','; // 关键字，多个关键字用逗号分隔
const indexNowKey = 'fbe0721f84454077a304831426093d8d'; // 替换为你的API密钥
